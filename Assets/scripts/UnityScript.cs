...
public class UnityScript : MonoBehaviour
{
    ...
    // inspector 창에 표시되지않고 스크립트창에서 사용을 하고싶으면 private로 바꿔줌
    ...
    [SerializeField]        // private 이지만 inspector 창에서 컨트롤 하고 싶을 경우
    private int privateValue;
    [HideInInspector]       // public 이지만 inspector 창에서 숨기고 싶을 경우 (코드로 컨트롤 하고 싶을 경우)
    public int publicValue;

    [Range(0, 10)]          // range 슬라이드 생성
